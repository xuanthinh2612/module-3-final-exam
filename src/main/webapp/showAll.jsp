...
<table>
    ...
    <c:forEach items="${productList}" var="product">
        <tr>
            ...
            <td><a href="" data-bs-toggle="modal" data-bs-target="#exampleModal${product.getId()}" type="button">Delete</a></td>
        </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="confirmDelete(${product.getId()})">
                            Delete
                        </button>
                    </div>
                </div>
